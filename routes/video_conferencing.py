...
async def create_video_conferencing(
    ...
    query = """
        INSERT INTO video_conferencing (name, description, status, data)
        VALUES ($1, $2, $3, $4)
...
async def list_video_conferencing(
    ...
    query = "SELECT * FROM video_conferencing WHERE 1=1"
    params = []
    param_count = 0
...
async def get_video_conferencing(
    ...
    query = "SELECT * FROM video_conferencing WHERE id = $1"
...
async def delete_video_conferencing(
    ...
    query = "DELETE FROM video_conferencing WHERE id = $1 RETURNING id"
...
async def get_video_conferencing_stats(conn: asyncpg.Connection = Depends(get_db)):
