...
async def create_project_templates(
    ...
    query = """
        INSERT INTO project_templates (name, description, status, metadata)
        VALUES ($1, $2, $3, $4)
...
async def get_project_templates(
    ...
    query = "SELECT * FROM project_templates WHERE id = $1"
...
async def delete_project_templates(
    ...
    query = "DELETE FROM project_templates WHERE id = $1 RETURNING id"
