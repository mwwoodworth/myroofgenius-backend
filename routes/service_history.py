...
async def create_service_history(
    ...
    query = """
        INSERT INTO service_history (name, description, status, data)
        VALUES ($1, $2, $3, $4)
...
async def list_service_history(
    ...
    query = "SELECT * FROM service_history WHERE 1=1"
    params = []
    param_count = 0
...
async def get_service_history(
    ...
    query = "SELECT * FROM service_history WHERE id = $1"
...
async def delete_service_history(
    ...
    query = "DELETE FROM service_history WHERE id = $1 RETURNING id"
...
async def get_service_history_stats(conn: asyncpg.Connection = Depends(get_db)):
