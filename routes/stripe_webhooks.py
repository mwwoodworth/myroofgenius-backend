...
STRIPE_WEBHOOK_SECRET = os.getenv("STRIPE_WEBHOOK_SECRET", "whsec_MyRoofGeniusWebhookSecret")
...
async def handle_stripe_webhook(
    ...
    try:
        ...
        if STRIPE_WEBHOOK_SECRET and STRIPE_WEBHOOK_SECRET != "whsec_MyRoofGeniusWebhookSecret":
            try:
