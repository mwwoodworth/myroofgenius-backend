...
async def create_performance_tuning(
    ...
    query = """
        INSERT INTO performance_tuning (name, description, status, data)
        VALUES ($1, $2, $3, $4)
...
async def list_performance_tuning(
    ...
    query = "SELECT * FROM performance_tuning WHERE 1=1"
    params = []
    param_count = 0
...
async def get_performance_tuning(
    ...
    query = "SELECT * FROM performance_tuning WHERE id = $1"
...
async def delete_performance_tuning(
    ...
    query = "DELETE FROM performance_tuning WHERE id = $1 RETURNING id"
...
async def get_performance_tuning_stats(conn: asyncpg.Connection = Depends(get_db)):
