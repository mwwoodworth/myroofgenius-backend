...
async def create_iso_compliance(
    ...
    query = """
        INSERT INTO iso_compliance (name, description, status, data)
        VALUES ($1, $2, $3, $4)
...
async def list_iso_compliance(
    ...
    query = "SELECT * FROM iso_compliance WHERE 1=1"
    params = []
    param_count = 0
...
async def get_iso_compliance(
    ...
    query = "SELECT * FROM iso_compliance WHERE id = $1"
...
async def delete_iso_compliance(
    ...
    query = "DELETE FROM iso_compliance WHERE id = $1 RETURNING id"
...
async def get_iso_compliance_stats(conn: asyncpg.Connection = Depends(get_db)):
