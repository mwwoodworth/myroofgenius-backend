#!/usr/bin/env python3
"""
DEPLOYMENT v3.3.16 - SQLAlchemy Async Pool Fix
- Fixed QueuePool incompatibility with asyncio
- Using NullPool for Supabase pooler connections
- Using AsyncAdaptedQueuePool for direct connections
"""
import requests
import time
...
print("🚀 DEPLOYING v3.3.16 - ASYNC POOL FIX")
print("=" * 60)
print("CRITICAL FIXES:")
print("  ✅ SQLAlchemy async pool compatibility fixed")
print("  ✅ NullPool for Supabase pooler")
print("  ✅ AsyncAdaptedQueuePool for direct connections")
print()
...
data = {
    ...
    "image": {
        ...
        "imagePath": "docker.io/mwwoodworth/brainops-backend:v3.3.16",
