...
async def lifespan(app: FastAPI):
    ...
    print("🚀 Starting BrainOps Backend v160.0.4 - TENANT_ID FIX (multi-tenant support)")
    print("=" * 80)
    ...
    try:
        ...
        print("\n" + "=" * 80)
        print("✅ BrainOps Backend v160.0.4 FULLY OPERATIONAL")
        print("=" * 80 + "\n")
    ...
    # Cleanup
    print("👋 Shutting down BrainOps Backend v160.0.4")
    if db_pool:
        await db_pool.close()
