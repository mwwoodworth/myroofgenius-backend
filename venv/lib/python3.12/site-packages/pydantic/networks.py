...
class PostgresDsn(_BaseMultiHostUrl):
    ...
    * Supports multiple hosts
    ...
    m = MyDatabaseModel(db='postgres://user:<DB_PASSWORD_REDACTED>@localhost:5432/foobar')
    print(m.db)
    #> postgres://user:<DB_PASSWORD_REDACTED>@localhost:5432/foobar

    try:
        MyDatabaseModel(db='postgres://user:<DB_PASSWORD_REDACTED>@localhost:5432')
    except ValidationError as e:
        print(e)
        '''
        ...
        assert (None)
         +  where None = PostgresDsn('postgres://user:<DB_PASSWORD_REDACTED>@localhost:5432').path [type=assertion_error, input_value='postgres://user:<DB_PASSWORD_REDACTED>@localhost:5432', input_type=str]
        '''
    ```
    """
