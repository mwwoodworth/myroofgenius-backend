...
class TimescaleVector(VectorStore):
    ...
    Example:
        .. code-block:: python
            ...
            SERVICE_URL = "postgres://tsdbadmin:<DB_PASSWORD_REDACTED>@<id>.tsdb.cloud.timescale.com:<port>/tsdb?sslmode=require"
    ...
    def service_url_from_db_params(
        ...
        return f"postgresql://{user}:<DB_PASSWORD_REDACTED>@{host}:{port}/{database}"
