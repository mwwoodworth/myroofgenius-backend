#!/usr/bin/env python3
"""
analyst-agent - Data analysis and insights agent
AI Model: claude-3
Port: 6002
"""
...
async def heartbeat():
    while True:
        ...
        logger.info(f"{'analyst-agent'} heartbeat - Status: {agent_state.status}, Tasks: {agent_state.tasks_processed}")

@app.on_event("startup")
async def startup_event():
    asyncio.create_task(heartbeat())
    logger.info(f"{'analyst-agent'} started on port 6002")
